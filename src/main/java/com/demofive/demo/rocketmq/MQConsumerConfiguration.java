...
//    @Value("${apache.rocketmq.consumer.PushConsumer}")
    public String groupName = "Producer";
//    @Value("${classpath:rocketmq.consumer.consumeThreadMin:4096}")
...
//        }
         ...
         * 设置一次消费消息的条数，默认为1条
         */
        consumer.setConsumeMessageBatchMaxSize(new Integer(consumeMessageBatchMaxSize));
        try {
            /**
